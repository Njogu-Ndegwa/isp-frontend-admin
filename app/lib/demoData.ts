...
export const demoShopProducts: ShopProduct[] = [
  {
    ...
    price: 4500.00,
    stock_quantity: 18,
    image_url: 'https://upload.wikimedia.org/wikipedia/commons/9/92/MikroTik_hAP_ac2.jpg',
    category: 'Routers',
    is_active: true,
    created_at: iso(30),
    ...
    images: [
      'https://upload.wikimedia.org/wikipedia/commons/9/92/MikroTik_hAP_ac2.jpg',
      'https://images.unsplash.com/photo-1544197150-b99a580bb7a8?w=800&q=80',
      'https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=800&q=80',
    ],
    highlights: [
      '2.4 GHz + 5 GHz concurrent dual-band Wi-Fi (AC1200)',
      '5× Gigabit Ethernet ports (1 WAN + 4 LAN)',
      'USB port for 3G/4G modem backup',
      'RouterOS v7 — full ISP-grade control',
    ],
    specifications: [
      { label: 'CPU', value: 'IPQ-4018 488–896 MHz quad-core (auto)' },
      ...
      { label: 'Antennas', value: '2× internal dual-band (2.5 dBi each)' },
      { label: 'USB', value: '1× USB Type-A (max 1A)' },
      { label: 'Operating System', value: 'RouterOS v7 (Level 4)' },
      { label: 'Power Input', value: '12–30V DC jack / Passive PoE 18–28V' },
      { label: 'Power Consumption', value: '21W max (16W without modem)' },
      { label: 'Dimensions', value: '34 × 119 × 98 mm' },
  ...
  },
  {
    ...
    highlights: [
      '5× Gigabit Ethernet ports — no Wi-Fi, pure wired speed',
      'Dual-core 880 MHz CPU — handles BGP full table',
      'USB port for 3G/4G backup modem',
      'Full RouterOS v7 — BGP, OSPF, MPLS, PPPoE ready',
    ],
    specifications: [
      { label: 'CPU', value: '880 MHz dual-core (MIPS)' },
      { label: 'RAM', value: '256 MB DDR3' },
      { label: 'Storage', value: '16 MB NAND' },
      { label: 'Ethernet Ports', value: '5× 10/100/1000 Mbps' },
      { label: 'USB', value: '1× USB 3.0' },
      { label: 'Operating System', value: 'RouterOS v7 (Level 4)' },
      { label: 'Power Input', value: '8–30V DC or Passive PoE' },
  ...
  },
  {
    ...
    description: '300 Mbps wireless N router — the most affordable entry-level option for home hotspot setups. Built-in 2× fixed antennas and four LAN ports make it ideal for deploying small hotspot zones for cafés, shops, and rental houses.',
    price: 1800.00,
    stock_quantity: 32,
    image_url: 'https://upload.wikimedia.org/wikipedia/commons/a/a0/TP-Link_WR841ND_WiFi_router_transparent.png',
    category: 'Routers',
    is_active: true,
    created_at: iso(22),
    sku: 'TL-WR841N-V14',
  ...
  },
  {
    ...
    price: 6800.00,
    stock_quantity: 9,
    image_url: 'https://upload.wikimedia.org/wikipedia/commons/4/43/Ubiquiti_NanoStation_M5_P1110402.jpg',
    category: 'CPE',
    is_active: true,
    created_at: iso(14),
    sku: 'LOCOM5',
    ...
    images: [
      'https://upload.wikimedia.org/wikipedia/commons/4/43/Ubiquiti_NanoStation_M5_P1110402.jpg',
      'https://upload.wikimedia.org/wikipedia/commons/thumb/4/43/Ubiquiti_NanoStation_M5_P1110402.jpg/960px-Ubiquiti_NanoStation_M5_P1110402.jpg',
      'https://images.unsplash.com/photo-1614064641938-3bbee52942c7?w=800&q=80',
    ],
    highlights: [
      '5 GHz airMAX CPE — up to 15+ km link range',
      '13 dBi dual-linear polarisation built-in antenna',
      'Passive PoE powered — single cable install',
      'IP65 weatherproof, rated to −30°C/+75°C',
    ],
    specifications: [
      { label: 'Processor', value: 'Atheros MIPS 24KC 400 MHz' },
      { label: 'RAM', value: '32 MB SDRAM' },
      { label: 'Flash', value: '8 MB' },
      { label: 'Frequency', value: '5170–5875 MHz' },
      { label: 'Gain', value: '13 dBi' },
      { label: 'Beamwidth', value: '45° H / 45° V / 45° Elevation' },
      { label: 'Cross-pol Isolation', value: '20 dB min.' },
      { label: 'Max Throughput', value: '150+ Mbps' },
      { label: 'Ethernet', value: '1× 10/100 Mbps RJ45 (PoE-in)' },
      { label: 'Power', value: '24V 0.5A Passive PoE (adapter included)' },
      { label: 'Max Power Consumption', value: '5.5W' },
      { label: 'Dimensions', value: '161 × 31 × 80 mm' },
      { label: 'Weight', value: '180 g' },
      { label: 'Weatherproofing', value: 'IP65 UV-stabilised plastic' },
  ...
  },
  {
    ...
    specifications: [
      ...
      { label: 'MAC Table', value: '8,000 entries' },
      { label: 'Jumbo Frames', value: '10 KB' },
      { label: 'Management', value: 'Unmanaged (plug-and-play)' },
      { label: 'Rackmount', value: '1U, 19" rack (ears included)' },
      { label: 'Power', value: 'Internal, 100–240V AC 50/60 Hz' },
      { label: 'Power Consumption', value: '13.62W max' },
      { label: 'Operating Temp', value: '0°C to +40°C' },
      { label: 'Dimensions', value: '294 × 180 × 44 mm (438 mm with rack ears)' },
    ],
  },
  {
    id: 8,
  ...
  },
  {
    ...
    price: 98000.00,
    stock_quantity: 3,
    image_url: 'https://upload.wikimedia.org/wikipedia/commons/d/d0/Mikrotik_RB2011UiAS-RM_%2819174658945%29.jpg',
    category: 'Routers',
    is_active: true,
    created_at: iso(8),
    ...
    images: [
      'https://upload.wikimedia.org/wikipedia/commons/d/d0/Mikrotik_RB2011UiAS-RM_%2819174658945%29.jpg',
      'https://images.unsplash.com/photo-1639322537504-6427a16b0a28?w=800&q=80',
      'https://images.unsplash.com/photo-1597733336794-12d05021d510?w=800&q=80',
    ],
    highlights: [
  ...
  // ─── Starlink ─────────────────────────────────────────────────────
  {
    ...
    price: 68000.00,
    stock_quantity: 6,
    image_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/25/Starlink_dish_01.webp/960px-Starlink_dish_01.webp.png',
    category: 'Starlink',
    is_active: true,
    created_at: iso(5),
    sku: 'SL-STD-GEN3',
    ...
    tags: ['bestseller', 'new'],
    images: [
      'https://upload.wikimedia.org/wikipedia/commons/thumb/2/25/Starlink_dish_01.webp/960px-Starlink_dish_01.webp.png',
      'https://upload.wikimedia.org/wikipedia/commons/d/df/Starlink_Router_%2851228513015%29.jpg',
  ...
  },
  {
    ...
    price: 45000.00,
    stock_quantity: 4,
    image_url: 'https://upload.wikimedia.org/wikipedia/commons/d/df/Starlink_Router_%2851228513015%29.jpg',
    category: 'Starlink',
    is_active: true,
    created_at: iso(3),
    sku: 'SL-MINI-V1',
  ...
  // ─── Access Points ─────────────────────────────────────────────────
  {
    ...
    price: 9500.00,
    stock_quantity: 11,
    image_url: 'https://upload.wikimedia.org/wikipedia/commons/f/f8/Unifi_AC_Lite_Access_Point.jpg',
    ...
    tags: ['wifi6', 'popular'],
    images: [
      'https://upload.wikimedia.org/wikipedia/commons/f/f8/Unifi_AC_Lite_Access_Point.jpg',
      'https://upload.wikimedia.org/wikipedia/commons/3/30/Ubiquiti_Unifi_AP.jpg',
  ...
  },
  {
    ...
    price: 6800.00,
    stock_quantity: 15,
    image_url: 'https://upload.wikimedia.org/wikipedia/commons/3/30/Ubiquiti_Unifi_AP.jpg',
    category: 'Access Points',
    is_active: true,
    created_at: iso(11),
  ...
  // ─── Tenda / Budget Routers ─────────────────────────────────────────
  {
    ...
    price: 1350.00,
    stock_quantity: 55,
    image_url: 'https://images.unsplash.com/photo-1601598851547-4302969d0614?w=800&q=80',
    category: 'Routers',
    is_active: true,
    created_at: iso(19),
    sku: 'TENDA-F3-V9',
