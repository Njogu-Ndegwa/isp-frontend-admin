    ...
    <div className="w-full space-y-5">
        ...
        <ResponsiveContainer width="100%" height="100%">
          ...
          >
            ...
            <Area
              ...
              dot={false}
              activeDot={{ r: 5, fill: 'var(--chart-3)', stroke: '#fff', strokeWidth: 2 }}
            />
          </AreaChart>
        </ResponsiveContainer>
      </div>
      ...
      {hasServiceUsage && (
        <div className="h-44 sm:h-52 w-full">
          <ResponsiveContainer width="100%" height="100%">
            <BarChart accessibilityLayer data={displayData} margin={{ top: 8, right: 10, left: 0, bottom: 0 }}>
              <CartesianGrid
                strokeDasharray="3 3"
                stroke="var(--border)"
                vertical={false}
              ...
              />
              <Bar dataKey="hotspotTotalMB" stackId="usage" fill="var(--chart-1)" radius={[3, 3, 0, 0]} />
              <Bar dataKey="pppoeTotalMB" stackId="usage" fill="var(--chart-4)" radius={[3, 3, 0, 0]} />
            </BarChart>
          </ResponsiveContainer>
        </div>
      )}
