  ...
  return (
    ...
    >
      <a
        ...
        className="w-12 h-12 rounded-full bg-background/90 backdrop-blur border border-border shadow-lg flex items-center justify-center text-foreground hover:border-amber-500/50 hover:text-amber-500 transition-colors"
      >
