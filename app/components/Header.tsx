      ...
      <header className="mb-5 sm:mb-8">
        <div className="flex items-start justify-between gap-3">
          ...
          <div className="flex items-start gap-3 min-w-0">
            ...
            {!backHref && (
              <button
                ...
                className="md:hidden mt-1 p-1.5 -ml-1.5 rounded-lg text-foreground-muted hover:text-foreground hover:bg-background-tertiary transition-colors active:opacity-70 touch-manipulation flex-shrink-0"
              >
          ...
          <div className="flex items-center gap-3 flex-shrink-0">
            ...
            <Link
              href="/settings"
              className="hidden md:flex p-2 rounded-lg text-foreground-muted hover:text-foreground hover:bg-background-tertiary transition-all"
              title="Settings"
            >
