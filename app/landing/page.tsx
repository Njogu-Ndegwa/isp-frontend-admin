...
const FEATURES = [
  {
    ...
    desc: 'Auto-generate invoices, integrate mobile money & bank payments, and reconcile in real time. No more spreadsheets or 2 AM disconnect calls.',
          ...
          <Reveal delay={0.1}>
            <div className="grid sm:grid-cols-2 gap-4 text-left">
              {[
                ...
                'Spending hours reconciling mobile payment transactions with spreadsheets',
              ].map((pain, i) => (
