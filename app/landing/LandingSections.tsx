      ...
      <section id="contact" className="py-20 md:py-28 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 gap-4 mb-8">
            <a href={`tel:${PHONE_NUMBER}`} onClick={() => trackContact('phone', 'contact_section')} className="group card p-6 flex items-center gap-4 hover:border-amber-500/40 transition-colors">
            ...
            <a href={`https://wa.me/${PHONE_NUMBER.replace('+', '')}`} target="_blank" rel="noopener noreferrer" onClick={() => trackContact('whatsapp', 'contact_section')} className="group card p-6 flex items-center gap-4 hover:border-emerald-500/40 transition-colors">
